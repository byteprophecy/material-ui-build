...
// After Noon
'12:00 PM - 01:00 PM', '01:00 PM - 02:00 PM', '02:00 PM - 03:00 PM', '03:00 PM - 04:00 PM', '04:00 PM - 05:00 PM', '05:00 PM - 06:00 PM', '06:00 PM - 07:00 PM', '07:00 PM - 08:00 PM', '08:00 PM - 09:00 PM', '09:00 PM - 10:00 PM', '10:00 PM - 11:00 PM', '11:00 PM - 12:00 PM'];
              ...
              _react2.default.createElement(
                ...
                this.state.hours.map(function (item, index) {
                  return _this2.props.currentHour == item.key ? _react2.default.createElement(
                    'option',
                    { key: index, value: item.key, selected: true },
                    item.value
                  ) : _react2.default.createElement(
                    'option',
